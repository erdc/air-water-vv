...
Refinement = 18#45min on a single core for spaceOrder=1, useHex=False
genMesh=True
movingDomain=False
...
if useHex:   
    ...
    if structured:
        ...
        vertexFlags=[boundaryTags['bottom'],
                     ...
                     boundaryTags['top'],
                     boundaryTags['top'],
                     boundaryTags['bottom'],boundaryTags['bottom'],boundaryTags['bottom'],boundaryTags['bottom']]
        segments=[[0,1],
                  [1,2],
                  [2,3],
                  [3,0],
...
if useMetrics:
    ...
    redist_Newton = True
    kappa_shockCapturingFactor = 0.2
    kappa_lag_shockCapturing = True#False
    kappa_sc_uref = 1.0
    kappa_sc_beta = 1.0
    dissipation_shockCapturingFactor = 0.2
