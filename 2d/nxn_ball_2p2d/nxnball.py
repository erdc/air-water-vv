...
ct = Context.Options([
    ...
    ("n_row",               2,"how many rows"),
    ("n_col",               2,"how many columns"),
    ("between_balls",       2.0,"distance between two near balls; unit is D"),
    ("to_top",              1.5,"distance between top edge and first row of balls; unit is D"),
    ("to_left",             4.5,"distance between left edge and first column of balls; unit is D"),
    #########################################
