...
inflowHeightMean = 2.5
outflowHeightMean = 0.15
...
obst_portions = (0.01,0.25) #(width,height)
obst_x_start = 4.0  # start x coordinate of the obstacle; caution to be in the domain's range
...
#airvent_y1=1.0*obst_portions[1]/4.0
...
x_refine = (0.5 , 3.0 , 3.5) #end of zone 1, end of zone 2, end of zone 3 (zone 4 is up to the right wall)
