...
#h-sizes defined to be twice and half the base mesh size, respectively
hmax = he*2
hmin = he/2.0
MeshAdaptMesh=MeshAdaptPUMI.MeshAdaptPUMI(hmax=hmax, hmin=hmin, numIter=adaptMesh_numIter,sfConfig="ERM",targetError=100,targetElementCount=40000)
#MeshAdaptMesh=MeshAdaptPUMI.MeshAdaptPUMI(hmax=hmax, hmin=hmin, numIter=adaptMesh_numIter,sfConfig="isotropic")
useModel=False#True
