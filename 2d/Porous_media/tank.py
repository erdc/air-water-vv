...
opts=Context.Options([
    ...
    ('D', 1.96*(10**6), 'Resistance term calculated and used directly as dragAlpha'), # [1.96*(10**6), 2.45*(10**6), 3.27*(10**6), 4.90*(10**6)]
    # numerical options
...
dragAlpha=(porosity**2)*opts.D #1.96*(10**6) #(porosity**2)*Alpha/nu_0
