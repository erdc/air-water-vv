def CreateFig():
    ...
    archive = openFile('wave_validation.h5','r')
    import wave_validation
    import wave_validation_so
    import matplotlib.tri as mtri
    from matplotlib import pyplot as  plt
    import numpy as np
    domain = wave_validation.domain
