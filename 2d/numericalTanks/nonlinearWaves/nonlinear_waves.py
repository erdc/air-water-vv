...
opts = Context.Options([
    ...
    ("Ycoeff",(0.05285227, 0.00777215, 0.00103578, 0.00014615, 0.00002224,
               0.00000360, 0.00000062, 0.00000021),
              "YCoeff array from Fenton calculation tool"),
    ("Bcoeff",(0.06693872, 0.00481371, 0.00028641, 0.00000865, 0.00000056,
               0.00000010, 0.00000000, 0.0000000),
              "Bcoeff array from calculation tool"),
    # probe dx
...
if spaceOrder == 1:
    ...
    if useHex:
        ...
        elementBoundaryQuadrature = ft.CubeGaussQuadrature(nd - 1, 3) #[temp] 3? Others have 2 for their order.
    else:
