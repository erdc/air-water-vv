...
import WaveTools
#DO NOT FORGET TO CHANGE SIGNS IN THE RELAXATION ZONES AFTER THE COMPILATION
#wave generator
...
if useHex:   
    ...
    if structured:
        ...
        epsFact_solidTypes = np.array([0.0,epsFact_solid,0.0])
...
rzWaveGenerator = RelaxationZoneWaveGenerator(zones={
                                                    1:RelaxationZone(xRelaxCenter_2,
                                                                     1.0, #until is compiled, correct -1
                                                                     zeroVel,
                                                                     zeroVel,
                                                                     zeroVel)})
