...
opts=Context.Options([
    ...
    ('th', 1.0, 'Total height of the numerical tank'),
    # waves
    ...
    ('fast', False, 'If True switch for optimised functions'),    
    # numerical options
    ...
    ("duration", 30.0, "Duration of the simulation. Better if in terms of wave period"),
    ("he", 0.00,"Mesh size"),
    ("cfl", 0.90 ,"Target cfl"),
