...
setup(name='ChMBDModel',
      ...
      ext_modules=[
                    Extension("Chrono3D",['Chrono3D.pyx'],
                             depends=['Chrono3D.h'],
                             language='c++',
                             include_dirs=[config.PROTEUS_INCLUDE_DIR+'/chrono/collision/convexdecomposition/HACD',
                                           config.PROTEUS_INCLUDE_DIR+'/chrono/collision/bullet',
                             ...
                             libraries=['ChronoEngine',
                              ...
                              extra_link_args = ['-L'+config.PROTEUS_LIB_DIR,'-Wl,-rpath,' + config.PROTEUS_LIB_DIR]),
                ]
      )
