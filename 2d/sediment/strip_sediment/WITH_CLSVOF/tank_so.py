...
if ct.sedimentDynamics:
    if ct.useCLSVOF:
        ...
        pnList = [("vos_p",               "vos_n"),#0
                  ("clsvof_p",            "clsvof_n"),#1
                  ("threep_navier_stokes_sed_p", "threep_navier_stokes_sed_n"),#2
                  ("twp_navier_stokes_p", "twp_navier_stokes_n"),#3
                  ("pressureincrement_p", "pressureincrement_n"),#4
                  ("pressure_p", "pressure_n"),#5
                  ("pressureInitial_p", "pressureInitial_n")]#6
    else:
        PINIT_model=9
        pnList = [("vos_p",               "vos_n"),#0
                  ("vof_p",               "vof_n"),#1
