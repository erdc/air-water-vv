...
opts=Context.Options([
    ...
    ("water_level", 0.4785, "Height of free surface above seabed"),
    # tank
    ...
    ("gaugeColumn", [13.82,32.23], "Horizontal spacing of point gauges/column gauges"),
    # waves
    ("waves", True, "Generate waves (True/False)"),
    ("wave_period", 1.5, "Period of the waves"),
...
def Update_Model():
    ...
    # Temporal Fix to make available all variables in the context variable
...
def signedDistance(x,waterLine_z=waterLevel):
