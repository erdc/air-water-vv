...
opts=Context.Options([
    ...
    # formulation choices
    ("space_order", 1, "Linear (1) or Quadratic (2) elements."),
    ("use_hex", False, "Use Hexahedral elements (otherwise, tetrahedral)"),
    ("use_rbles", 0.0, "SUPG (0) or RBLES (1.0) for stability"),
    ("use_metrics", 1.0, "Use metric based (1.0) numerical parameters (0.0 for h based)."),
    # run details
...
spaceOrder = opts.space_order
useHex = opts.use_hex
useRBLES = opts.use_rbles
useMetrics = opts.use_metrics
