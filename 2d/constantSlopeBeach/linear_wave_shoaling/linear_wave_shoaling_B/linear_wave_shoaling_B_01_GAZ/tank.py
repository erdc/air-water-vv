...
for i in range(0,int(L[0]/gauge_dx+1)): #+1 only if gauge_dx is an exact 
  PGL.append([gauge_dx*i,0.7,0])
  if gauge_dx*i< x_slope_start:
      a = 0.0
  elif gauge_dx*i>=x_slope_start and gauge_dx*i<x_slope_end:
      a= slope*(gauge_dx*i-x_slope_start)
  else: 
      a=y_slope_end
 # print a , gauge_dx*i
