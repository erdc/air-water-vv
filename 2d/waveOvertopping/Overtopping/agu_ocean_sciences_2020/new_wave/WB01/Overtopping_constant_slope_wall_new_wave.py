...
opts=Context.Options([
    ...
    ("wall_height",0.15,"height of the structure wall from levee crest"),
...
obs_vertices=[
    ...
    #levee crest#    
            [3*wave_length+opts.tube+opts.structureCrestLevel*opts.structure_slope+opts.crest_width,opts.structureCrestLevel+opts.wall_height],#5
            [3*wave_length+opts.tube+opts.structureCrestLevel*opts.structure_slope,opts.structureCrestLevel+opts.wall_height],#6
            [3*wave_length+opts.tube+opts.structureCrestLevel*opts.structure_slope,opts.structureCrestLevel],#7
    
    #levee toe#
            [3*wave_length+opts.tube,0],#8
            ]  
...
LG=[((3*wave_length+opts.tube+opts.structureCrestLevel*opts.structure_slope+opts.crest_width*0.5,opts.structureCrestLevel+opts.wall_height,0.),
