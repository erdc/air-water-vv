...
obs_vertices=[
    ...
    #levee crest#    
            [3*wave_length+opts.tube+opts.structureCrestLevel*opts.structure_slope+opts.crest_width,opts.structureCrestLevel+0.4572],#5    
            [3*wave_length+opts.tube+opts.structureCrestLevel*opts.structure_slope,opts.structureCrestLevel+0.4572],#6
    
    #levee toe#
            [3*wave_length+opts.tube+opts.structureCrestLevel*opts.structure_slope,0],#7
            ]  
...
LG=[((3*wave_length+opts.tube+opts.structureCrestLevel*opts.structure_slope+opts.crest_width*0.5,opts.structureCrestLevel+0.4572,0.),
