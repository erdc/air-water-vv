...
opts=Context.Options([
    ...
    ("crest_width",0.3048,"width of the structure crest"),
    ...
    ("mwl", 2.49936, "Mean Water level"),#0.4
   ...
   # Numerical Options
    ...
    ("structureCrestLevel", 2.8956, "elevation of structure crest. Equal to Water depth + Rc (crest freeboard)")#0.5
    ])
...
obs_vertices=[
    ...
    #levee crest#    
            [3*wave_length+opts.tube+opts.structureCrestLevel*opts.structure_slope+opts.crest_width,opts.structureCrestLevel],#5    
            [3*wave_length+opts.tube+opts.structureCrestLevel*opts.structure_slope-opts.crest_width,opts.structureCrestLevel],#6
            [3*wave_length+opts.tube+opts.structureCrestLevel*opts.structure_slope-opts.crest_width,opts.structureCrestLevel-opts.crest_width*0.5],#7
            [3*wave_length+opts.tube+opts.structureCrestLevel*opts.structure_slope,opts.structureCrestLevel-opts.crest_width*0.5],#8
    #levee toe#
            [3*wave_length+opts.tube+opts.structureCrestLevel*opts.structure_slope,0],#9
            ]  
...
LG=[((3*wave_length+opts.tube+opts.structureCrestLevel*opts.structure_slope+opts.crest_width*0.5,opts.structureCrestLevel,0.),
