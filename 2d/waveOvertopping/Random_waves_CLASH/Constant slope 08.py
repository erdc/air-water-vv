...
opts=Context.Options([
    ...
    ("xO", np.array([0.,0.,0.]), "Position vector for the tinme series"),
    ...
    ("spectal_params",{"gamma": 3.3, "TMA":False,"depth": 0.4} ,"Spectral Distribution Characteristics"),
