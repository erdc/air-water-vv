...
wavelength = 3.382 #=5.0 without the current
k = 2.0*math.pi/wavelength
rampTime = 5.0*period
meanFrameVelocity = 2.244 #calculated from FFT
outflowHeightMean = inflowHeightMean
netcurrentVelocity = wavelength/period-meanFrameVelocity

Y =  [0.03912757,  # Surface elevation Fourier coefficients for non-dimensionalised solution, calculated from FFT       
      0.00092918,    
      0.00003025,      
      0.00000117,
      0.00000005]
...
B = [0.04007891,   # Velocities Fourier coefficients for non-dimensionalised solution, calculated from FFT
     0.00012203,
     -0.00000122,
     0.]
...
g = np.array([0, -9.81, 0])
waves = MonochromaticWave(period = period,
...
he = wavelength/200 # Background refinement, try also /200 
...
leftSponge = 3.382 # wavelength
rightSponge = 6.764 # wavelength*2.0
