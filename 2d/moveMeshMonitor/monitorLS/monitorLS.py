...
opts=Context.Options([
    ...
    ('tank_x', 3., 'Length of tank'),
    ('tank_y', 1., 'Height of tank'),
    ('tank_sponge_wavelength_scale', True, 'True: sponge length relative to wavelength'),
    ("tank_sponge_xn", 0., "Length of absorption zones (front/back, left/right)"),
    ("tank_sponge_xp", 0., "Length of absorption zones (front/back, left/right)"),
