...
opts=Context.Options([
    ...
    ("caisson_corner_r", 0.0, "radius of the corners of the caisson"),
...
if opts.waves is True:
    ...
    if opts.wave_type == 'Linear':
        ...
        BCoeffs = np.zeros(3)#opts.Bcoeff
        YCoeffs = np.zeros(3)#opts.Ycoeff
...
hmax = he*2.0
hmin = he*0.1
MeshAdaptMesh=MeshAdaptPUMI.MeshAdaptPUMI(hmax=hmax, hmin=hmin, numIter=adaptMesh_numIter,sfConfig="meshQuality")
useModel=False#True
