...
setup(name='ChRigidBody',
      ...
      ext_modules=[Extension("ChRigidBody",['ChRigidBody.pyx'],
                             ...
                             language='c++',
                             include_dirs=[numpy.get_include(),'proteus','/lustre/usr/local/u/tridelat/PROTEUS/proteus/copper.gnu/include',
                                           '/lustre/usr/local/u/tridelat/PROTEUS/proteus/copper.gnu/include/chrono'],
                             library_dirs=['/lustre/usr/local/u/tridelat/PROTEUS/proteus/copper.gnu/lib', '/lustre/usr/local/u/tridelat/PROTEUS/proteus/copper.gnu/lib64'],
