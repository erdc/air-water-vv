...
opts=Context.Options([
    ...
    #("water_width", 1.9, "Width of  water column in m"),
    # tank
    ...
    #("T", 0.20,"Simulation time in s"),
    ("T", 0.40,"Simulation time in s"),
...
if useHex:
    ...
    adaptMesh_nSteps = 50#5
    adaptMesh_numIter = 5
    hmax = he;
    hmin = he/2.0;
    hPhi = he/2.0;#/4.0
    domain.PUMIMesh=MeshAdaptPUMI.MeshAdaptPUMI(hmax=hmax, hmin=hmin, hPhi = hPhi, adaptMesh=adaptMeshFlag, numIter=adaptMesh_numIter, numAdaptSteps=adaptMesh_nSteps,  sfConfig="isotropic",logType="on",reconstructedFlag=2,gradingFact=1.2)
    #domain.PUMIMesh=MeshAdaptPUMI.MeshAdaptPUMI(hmax=hmax, hmin=hmin, hPhi = hPhi, adaptMesh=adaptMeshFlag, numIter=adaptMesh_numIter, numAdaptSteps=adaptMesh_nSteps,  sfConfig="combined",logType="off",reconstructedFlag=2,gradingFact=1.2)
...
he = 0.03#tank_dim[0] / float(4 * refinement - 1)
