...
if useHex:
    ...
    if structured:
        ...
        vertices0 = [[0.0, 0.0],  #0
                    ...
                    [L[0], L[1]],  #2
                    [0.0, L[1]]]  #3
        vertices = [ [v[0]+x0[0], v[1]] for v in vertices0]
...
if useMetrics:
    ...
    epsFact_density    = 3.0
    epsFact_vos = epsFact_viscosity  = epsFact_curvature  = epsFact_vof = epsFact_consrv_heaviside = epsFact_consrv_dirac = epsFact_density
...
vos_nl_atol_res = max(1.0e-10, 0.001 * he ** 2)
ls_nl_atol_res = max(1.0e-10, 0.001 * he ** 2)
rd_nl_atol_res = max(1.0e-10, 0.005 * he)
mcorr_nl_atol_res = max(1.0e-10, 0.001 * he ** 2)
kappa_nl_atol_res = max(1.0e-10, 0.001 * he ** 2)
dissipation_nl_atol_res = max(1.0e-10, 0.001 * he ** 2)
phi_nl_atol_res = max(1.0e-10, 0.001 * he ** 2)
pressure_nl_atol_res = max(1.0e-10, 0.001 * he ** 2)
