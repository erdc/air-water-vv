...
if dambreak.sedimentDynamics:
    ...
    pnList = [("sw_hump_2d_p", "sw_hump_2d_c0p1_n"),#0
              ("vof_p",               "vof_n"),#1
              ("ls_p",                "ls_n"),#2
              ("redist_p",            "redist_n"),#3
              ("ls_consrv_p",         "ls_consrv_n"),#4
              ("twp_navier_stokes_p", "twp_navier_stokes_n"),#5
              ("pressureincrement_p", "pressureincrement_n"),#6
              ("pressure_p", "pressure_n"),#7
    ...
    dambreak.MCORR_model=4
    dambreak.V_model=5
    dambreak.PINC_model=6
    dambreak.PRESSURE_model=7
    dambreak.PINIT_model=8
