...
context_options += [
    ...
    ("g", (0, 0, -9.81), "Gravitational acceleration vector"),
    ]
# run time options
context_options += [
...
context_options += [
    ("water_level", 2.5, "Height of free surface above bottom"),
    ...
    ('tank_y', 5., 'Width of tank'),
    ('tank_z', 5., 'Height of tank'),
    ...
    # sphere
    ("fixStructure", True, "fix structure in place"),
...
# SPHERE
coords = np.array([tank_dim[0]/2., tank_dim[1]/2., tank_dim[2]/2.])
barycenter = np.array([tank_dim[0]/2., tank_dim[1]/2., tank_dim[2]/2.])
sphere = st.Sphere(domain,
                   radius=1.,
                   coords=coords,
...
mass = 4*np.pi/3*sphere.radius**3*opts.rho_0
...
params.physical.viscosityA = opts.nu_0  # water
params.physical.viscosityB = opts.nu_1  # air
