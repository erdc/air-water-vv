...
# Wave Conditions
Nf = 10
tS = timeSeries(timeSeriesFile = "monochromatic_linear_time_series.txt",
                d = L[2],
                Npeaks = 1, #m depth
...
def waveHeight(x,t):
     return inflowHeightMean + tS.reconstruct_direct(x[0], x[1], x[2], t, Nf, var = "eta")
 
def waveVelocity_u(x,t):
     return tS.reconstruct_direct(x[0], x[1], x[2], t, Nf, var = "U", ss="x")

def waveVelocity_v(x,t):
     return tS.reconstruct_direct(x[0], x[1], x[2], t, Nf, var = "U", ss="y")

def waveVelocity_w(x,t):
     return tS.reconstruct_direct(x[0], x[1], x[2], t, Nf, var = "U", ss="z")
#solution variables
