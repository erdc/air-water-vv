...
```bash
  mpirun -n NP parun marin_so.py -l 3 -v -O petsc.options.superlu_dist -C "he=0.2" -D OUTPUT_DIR
```

where NP stands for the number of processors and OUTPUT_DIR is an optional subdirectory for storing output. 
