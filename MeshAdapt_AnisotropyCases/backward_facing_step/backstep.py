...
if useHex:
    ...
    boundaries=['bottom1','bottom2','top','front1','front2','back','left','right']
    ...
    if structured:
        ...
        domain.faceList=[[112],[108],[104],[114],[110],[106],[56],[34]]
        ...
        domain.PUMIMesh=MeshAdaptPUMI.MeshAdaptPUMI(
            ...
            gradingFact=gradingFactor)

        #read the geometry and mesh
        mesh_dir = "%s-Procs/Backstep.smb" % comm.size()
        domain.PUMIMesh.loadModelAndMesh("Backstep.dmg", mesh_dir)
