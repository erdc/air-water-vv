...
if useHex:
    ...
    if structured:
        ...
        domain.faceList=[[80],[76],[24],[42],[82],[78]] #simmetrix
        ...
        case_mesh = "Dambreak.smb"
        case_model = "Dambreak.dmg"
        input_mesh = "%s/%s" % (model_dir,case_mesh)
        input_model = "%s/%s" % (model_dir,case_model)
        domain.PUMIMesh.loadModelAndMesh(input_model, input_mesh)
        domain.useModel=False
